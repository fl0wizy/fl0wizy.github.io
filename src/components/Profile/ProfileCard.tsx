    ...
    <div className="profile-card-container">
      ...
      <div className="contact-grid">
        {contacts.map((contact, index) => {
          const IconComponent = Icons[contact.type as keyof typeof Icons] || Icons.email;
          const iconColor = contactColors[contact.type] || contactColors.email;
          const hasLink = isLinkType(contact.type) && contact.link;
          
          return (
            <div 
              key={index} 
              className="contact-card"
              style={{ '--contact-icon-color': iconColor } as React.CSSProperties}
            >
              ...
              <div className="contact-content">
                ...
                {hasLink ? (
                  ...
                  <span className="contact-value contact-text">{contact.value}</span>
                )}
              </div>
              {!hasLink && (
                <button 
